...
import (
	...
	"github.com/apache/answer/internal/service/tip_common"
...
func initApplication(debug bool, serverConf *conf.Server, dbConf *data.Database, cacheConf *data.CacheConf, i18nConf *translator.I18n, swaggerConf *router.SwaggerConfig, serviceConf *service_config.ServiceConfig, uiConf *server.UI, logConf log.Logger) (*pacman.Application, func(), error) {
	...
	tipRepo := tip.NewTipRepo(dataData, uniqueIDRepo)
	tipCommonService := tipcommon.NewTipCommonService(tipRepo, questionRepo, answerRepo)
	answerController := controller.NewAnswerController(answerService, tipCommonService, rankService, captchaService, siteInfoCommonService, rateLimitMiddleware)
	...
	tipController := controller.NewTipController(tipCommonService)
